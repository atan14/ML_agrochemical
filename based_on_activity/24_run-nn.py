...
filename = "NN/%s/%s/batchsize%s/%s_epochs%s_dropout%s_lr%s_random_2" % (args.featurizer, args.kernel_regularizer, args.batch_size, args.regularizer_param, args.epochs, args.dropout_rate, lr)
...
model_func.cv_random_nn(model, X, Y, args.epochs, args.batch_size, args.num_split)
